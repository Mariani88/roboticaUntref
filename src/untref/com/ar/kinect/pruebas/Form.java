...
public class Form extends JFrame implements ActionListener {
	...
	private boolean colorSeleccionado, profundidadSeleccionada, ambosSeleccionado, alturaSeleccionada,
			curvasDeNivelSeleccionado, importarDatosSeleccionado;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == menuVistas.getItem(2)) {
			title = "Opciones para discriminar obst�culos";
		...
		if (e.getSource() == menuVistas.getItem(5)) {
			title = "Opciones de exportacion de Datos";
			this.setVisibilidadFiltrosImportacionDeDatos(true);
		...
		panelDeOpciones.setBorder(BorderFactory.createTitledBorder(border, title, TitledBorder.CENTER, TitledBorder.TOP,
				null, Color.BLUE));
	}
	...
	public void mostrarMensajeDeInicio() {
		...
		JOptionPane.showMessageDialog(null,
				"Instrucciones de uso:\n	" + "		1. Elija un tipo de vista del men� en la esquina superior izquierda\n	"
	...
	private JMenu construirMenuVistas() {
		...
		JMenuItem mi2 = new JMenuItem("Determinar obstaculos segun distancia");
		...
		JMenuItem mi4 = new JMenuItem("Opciones de Altura");
	...
	private JMenu construirMenuAyuda() {
		...
		JMenuItem item2 = new JMenuItem("Acerca de la Aplicacion");
	...
	public class MyActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (estadoOperacion) {
				JOptionPane.showMessageDialog(null, "Los datos fueron exportados con �xito");
				estadoOperacion = false;
			} else
				JOptionPane.showMessageDialog(null,
						"Surgio un error al exportar los datos.\nComuniquese con el administrador");
		}
	}
	...
	private void opcionesDeImportacionDeDatos() {
	...
	private void contruirPanelDeOpciones() {
		...
		this.opcionesDeImportacionDeDatos();
	...
	private void setVisibilidadFiltrosImportacionDeDatos(boolean bool) {
	...
	private void updateValues(MouseEvent e) {
		...
		double altura = 0.0;
		altura = data.getAltura(e.getX(), e.getY(), rango_altura);
	...
	public void actualizar() {
		...
		if (curvasDeNivelSeleccionado) {
			...
			int intervalo = Integer.parseInt(
					input_IntervaloEntreCurvas.getText().isEmpty() ? "3" : input_IntervaloEntreCurvas.getText());
			data.pintarCurvaNivel(intervalo * 100);
			imagen = data.getImagenColor();

		} else
			this.setVisibilidadFiltrosCurvasDeNivel(false);

		if (!importarDatosSeleccionado)
			this.setVisibilidadFiltrosImportacionDeDatos(false);
